...
<body class="bg-[#f2f7fc] text-gray-800 flex">
    ...
    <div class="flex-1 flex flex-col h-screen overflow-y-auto">
        ...
        <div class="px-4 sm:px-8 pb-10 max-w-3xl mx-auto w-full space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-[#1e3a5f]">Tambah Anggota</h1>
                    <p class="text-sm text-gray-500 mt-1">
                        Tambahkan akun baru untuk dosen atau tendik.
                    </p>
                </div>
            ...
            <div class="bg-white shadow rounded-xl p-6 sm:p-8">
                <form action="index.php?controller=admin&action=tambahAnggota" method="POST" class="space-y-4">
                    <!-- NAMA -->
                    <div>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            <option value="tendik" <?= $role === 'tendik' ? 'selected' : '' ?>>Tendik</option>
                        </select>
                    </div>

                    <!-- JURUSAN (hanya dosen) -->
                    <div id="field-jurusan" class="<?= $role === 'dosen' ? '' : 'hidden' ?>">
                    ...
                    <!-- UNIT / JURUSAN (hanya tendik) -->
                    <div id="field-unit" class="<?= $role === 'tendik' ? '' : 'hidden' ?>">
                        <label for="unit_jurusan" class="block text-sm font-medium text-gray-700 mb-1">
                            Unit / Jurusan (untuk Tendik) *
                        </label>
                        <input
                            id="unit_jurusan"
                            type="text"
                            name="unit_jurusan"
                            value="<?= htmlspecialchars($unit_jurusan) ?>"
                            class="w-full px-4 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
    ...
    <script>
        ...
        const fieldJurusan = document.getElementById('field-jurusan');
        ...
        function updateRoleFields() {
            ...
            if (role === 'dosen') {
                ...
                fieldUnit.classList.add('hidden');
            } else if (role === 'tendik') {
                fieldJurusan.classList.add('hidden');
                fieldUnit.classList.remove('hidden');
            }
        }
